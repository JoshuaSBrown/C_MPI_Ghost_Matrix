...
int main(void){
    ...
    printf("Testing: sumAllCoreMatrix\n");
    {
        ...
        ((rv==0) ? (void) (0) : __assert_fail ("rv==0", "test_mpi_ghost_matrix.c", 453, __PRETTY_FUNCTION__));
        float rvf = sumAllCoreMatrix(((void *)0));
        ((rvf==-1.0) ? (void) (0) : __assert_fail ("rvf==-1.0", "test_mpi_ghost_matrix.c", 455, __PRETTY_FUNCTION__));
        rvf = sumAllCoreMatrix(gmat);
        printf("rvf %f\n",rvf);
        (((int)rvf==25) ? (void) (0) : __assert_fail ("(int)rvf==25", "test_mpi_ghost_matrix.c", 458, __PRETTY_FUNCTION__));
        rv = deleteGhostMatrix(&gmat);
        ((rv==0) ? (void) (0) : __assert_fail ("rv==0", "test_mpi_ghost_matrix.c", 460, __PRETTY_FUNCTION__));
        ((gmat==((void *)0)) ? (void) (0) : __assert_fail ("gmat==((void *)0)", "test_mpi_ghost_matrix.c", 461, __PRETTY_FUNCTION__));
    }

    printf("Testing: setElemNorthGhostMatrix\n");
    {
        ghost_matrix * gmat = newGhostMatrixCheckerboard(2,2,1,0,0,0);
        int rv = setElemNorthGhostMatrix(((void *)0),0,0,21.3);
        ((rv==-1) ? (void) (0) : __assert_fail ("rv==-1", "test_mpi_ghost_matrix.c", 468, __PRETTY_FUNCTION__));
        rv = setElemNorthGhostMatrix(gmat,1,0,23.8);
        ((rv==-1) ? (void) (0) : __assert_fail ("rv==-1", "test_mpi_ghost_matrix.c", 470, __PRETTY_FUNCTION__));
        rv = setElemNorthGhostMatrix(gmat,0,2,98);
        ((rv==-1) ? (void) (0) : __assert_fail ("rv==-1", "test_mpi_ghost_matrix.c", 472, __PRETTY_FUNCTION__));
        rv = setElemNorthGhostMatrix(gmat,0,1,7);
        ((rv==0) ? (void) (0) : __assert_fail ("rv==0", "test_mpi_ghost_matrix.c", 474, __PRETTY_FUNCTION__));
        rv = setElemNorthGhostMatrix(gmat,-1,0,54);
        ((rv==-1) ? (void) (0) : __assert_fail ("rv==-1", "test_mpi_ghost_matrix.c", 476, __PRETTY_FUNCTION__));
        rv = setElemNorthGhostMatrix(gmat,0,-1,42);
        ((rv==-1) ? (void) (0) : __assert_fail ("rv==-1", "test_mpi_ghost_matrix.c", 478, __PRETTY_FUNCTION__));
        rv = setElemNorthGhostMatrix(gmat,0,0,84);
        ((rv==0) ? (void) (0) : __assert_fail ("rv==0", "test_mpi_ghost_matrix.c", 480, __PRETTY_FUNCTION__));
        rv = deleteGhostMatrix(&gmat);
        ((rv==0) ? (void) (0) : __assert_fail ("rv==0", "test_mpi_ghost_matrix.c", 482, __PRETTY_FUNCTION__));
        ((gmat==((void *)0)) ? (void) (0) : __assert_fail ("gmat==((void *)0)", "test_mpi_ghost_matrix.c", 483, __PRETTY_FUNCTION__));
    }

    printf("Testing: getElemNorthGhostMatrix\n");
    {
        ghost_matrix * gmat = newGhostMatrixCheckerboard(2,2,1,0,0,0);
        float rvf = getElemNorthGhostMatrix(((void *)0),0,0);
        ((rvf==-1.0) ? (void) (0) : __assert_fail ("rvf==-1.0", "test_mpi_ghost_matrix.c", 490, __PRETTY_FUNCTION__));
        rvf = getElemNorthGhostMatrix(gmat,-1,0);
        ((rvf==-1.0) ? (void) (0) : __assert_fail ("rvf==-1.0", "test_mpi_ghost_matrix.c", 492, __PRETTY_FUNCTION__));
        rvf = getElemNorthGhostMatrix(gmat,0,-1);
        ((rvf==-1.0) ? (void) (0) : __assert_fail ("rvf==-1.0", "test_mpi_ghost_matrix.c", 494, __PRETTY_FUNCTION__));
        rvf = getElemNorthGhostMatrix(gmat,1,0);
        ((rvf==-1) ? (void) (0) : __assert_fail ("rvf==-1", "test_mpi_ghost_matrix.c", 496, __PRETTY_FUNCTION__));
        rvf = getElemNorthGhostMatrix(gmat,0,2);
        ((rvf==-1.0) ? (void) (0) : __assert_fail ("rvf==-1.0", "test_mpi_ghost_matrix.c", 498, __PRETTY_FUNCTION__));
        int rv = setElemNorthGhostMatrix(gmat,0,1,7);
        ((rv==0) ? (void) (0) : __assert_fail ("rv==0", "test_mpi_ghost_matrix.c", 500, __PRETTY_FUNCTION__));
        rvf = getElemNorthGhostMatrix(gmat,0,1);
        ((rvf==7) ? (void) (0) : __assert_fail ("rvf==7", "test_mpi_ghost_matrix.c", 502, __PRETTY_FUNCTION__));
        rv = setElemNorthGhostMatrix(gmat,0,0,84);
        ((rv==0) ? (void) (0) : __assert_fail ("rv==0", "test_mpi_ghost_matrix.c", 504, __PRETTY_FUNCTION__));
        rvf = getElemNorthGhostMatrix(gmat,0,0);
        ((rvf==84) ? (void) (0) : __assert_fail ("rvf==84", "test_mpi_ghost_matrix.c", 506, __PRETTY_FUNCTION__));
        rv = deleteGhostMatrix(&gmat);
        ((rv==0) ? (void) (0) : __assert_fail ("rv==0", "test_mpi_ghost_matrix.c", 508, __PRETTY_FUNCTION__));
        ((gmat==((void *)0)) ? (void) (0) : __assert_fail ("gmat==((void *)0)", "test_mpi_ghost_matrix.c", 509, __PRETTY_FUNCTION__));
    }

    printf("Testing: setElemSouthGhostMatrix\n");
    {
        ghost_matrix * gmat = newGhostMatrixCheckerboard(2,2,0,1,0,0);
        int rv = setElemSouthGhostMatrix(((void *)0),0,0,21.3);
        ((rv==-1) ? (void) (0) : __assert_fail ("rv==-1", "test_mpi_ghost_matrix.c", 516, __PRETTY_FUNCTION__));
        rv = setElemSouthGhostMatrix(gmat,1,0,23.8);
        ((rv==-1) ? (void) (0) : __assert_fail ("rv==-1", "test_mpi_ghost_matrix.c", 518, __PRETTY_FUNCTION__));
        rv = setElemSouthGhostMatrix(gmat,0,2,98);
        ((rv==-1) ? (void) (0) : __assert_fail ("rv==-1", "test_mpi_ghost_matrix.c", 520, __PRETTY_FUNCTION__));
        rv = setElemSouthGhostMatrix(gmat,0,0,7);
        ((rv==0) ? (void) (0) : __assert_fail ("rv==0", "test_mpi_ghost_matrix.c", 522, __PRETTY_FUNCTION__));
        rv = setElemSouthGhostMatrix(gmat,-1,0,54);
        ((rv==-1) ? (void) (0) : __assert_fail ("rv==-1", "test_mpi_ghost_matrix.c", 524, __PRETTY_FUNCTION__));
        rv = setElemSouthGhostMatrix(gmat,0,-1,42);
        ((rv==-1) ? (void) (0) : __assert_fail ("rv==-1", "test_mpi_ghost_matrix.c", 526, __PRETTY_FUNCTION__));
        rv = setElemSouthGhostMatrix(gmat,0,1,84);
        ((rv==0) ? (void) (0) : __assert_fail ("rv==0", "test_mpi_ghost_matrix.c", 528, __PRETTY_FUNCTION__));
        rv = deleteGhostMatrix(&gmat);
        ((rv==0) ? (void) (0) : __assert_fail ("rv==0", "test_mpi_ghost_matrix.c", 530, __PRETTY_FUNCTION__));
        ((gmat==((void *)0)) ? (void) (0) : __assert_fail ("gmat==((void *)0)", "test_mpi_ghost_matrix.c", 531, __PRETTY_FUNCTION__));
    }

    printf("Testing: getElemSouthGhostMatrix\n");
    {
        ghost_matrix * gmat = newGhostMatrixCheckerboard(2,2,0,1,0,0);
        float rvf = getElemSouthGhostMatrix(((void *)0),0,0);
        ((rvf==-1.0) ? (void) (0) : __assert_fail ("rvf==-1.0", "test_mpi_ghost_matrix.c", 538, __PRETTY_FUNCTION__));
        rvf = getElemSouthGhostMatrix(gmat,-1,0);
        ((rvf==-1.0) ? (void) (0) : __assert_fail ("rvf==-1.0", "test_mpi_ghost_matrix.c", 540, __PRETTY_FUNCTION__));
        rvf = getElemSouthGhostMatrix(gmat,0,-1);
        ((rvf==-1.0) ? (void) (0) : __assert_fail ("rvf==-1.0", "test_mpi_ghost_matrix.c", 542, __PRETTY_FUNCTION__));
        rvf = getElemSouthGhostMatrix(gmat,1,0);
        ((rvf==-1) ? (void) (0) : __assert_fail ("rvf==-1", "test_mpi_ghost_matrix.c", 544, __PRETTY_FUNCTION__));
        rvf = getElemSouthGhostMatrix(gmat,0,2);
        ((rvf==-1.0) ? (void) (0) : __assert_fail ("rvf==-1.0", "test_mpi_ghost_matrix.c", 546, __PRETTY_FUNCTION__));
        int rv = setElemSouthGhostMatrix(gmat,0,0,7);
        ((rv==0) ? (void) (0) : __assert_fail ("rv==0", "test_mpi_ghost_matrix.c", 548, __PRETTY_FUNCTION__));
        rvf = getElemSouthGhostMatrix(gmat,0,0);
        ((rvf==7) ? (void) (0) : __assert_fail ("rvf==7", "test_mpi_ghost_matrix.c", 550, __PRETTY_FUNCTION__));
        rv = setElemSouthGhostMatrix(gmat,0,1,84);
        ((rv==0) ? (void) (0) : __assert_fail ("rv==0", "test_mpi_ghost_matrix.c", 552, __PRETTY_FUNCTION__));
        rvf = getElemSouthGhostMatrix(gmat,0,1);
        ((rvf==84) ? (void) (0) : __assert_fail ("rvf==84", "test_mpi_ghost_matrix.c", 554, __PRETTY_FUNCTION__));
        rv = deleteGhostMatrix(&gmat);
        ((rv==0) ? (void) (0) : __assert_fail ("rv==0", "test_mpi_ghost_matrix.c", 556, __PRETTY_FUNCTION__));
        ((gmat==((void *)0)) ? (void) (0) : __assert_fail ("gmat==((void *)0)", "test_mpi_ghost_matrix.c", 557, __PRETTY_FUNCTION__));
    }
# 642 "test_mpi_ghost_matrix.c"
 return 0;
}
